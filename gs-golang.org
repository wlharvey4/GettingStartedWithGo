...
The first course,  /Getting Started with Go/, introduces the  basic elements of
the language including unique features such as slices that are not available in
